...
│   ├── audio.js          音效：audio/ mp3 文件音效（懒加载 + coeff 音量系数）+ 静音开关
...
├── audio/                mp3 音效素材（16 个：点击/过场/点亮/传导/升级/肃清/征服/契约/错误/打字/蓄力/翻页/羽毛笔/纸张/金币/壁炉）
├── img/                  美术素材（见第七节）
└── .asset-tools/
